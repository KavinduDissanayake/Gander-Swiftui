...
import SwiftUI
 ...
 struct ExpandableText: View {
    ...
    var lessButtonText: String = "less"
            ...
            .modifier(OverlayAdapter(alignment: .trailingLastTextBaseline, view: {
                if shouldShowMoreButton {
                    Button {
                        ...
                        Text(isExpanded ? lessButtonText : moreButtonText)
                            .font(moreButtonFont ?? font)
...
extension ExpandableText {
    ...
    /**
     ...
     - Parameter text: The text to use for the "show less" button. Defaults to `less`
     - Returns: A new `ExpandableText` instance with the specified "show less" button text applied.
     */
    func lessButtonText(_ text: String) -> Self {
        var copy = self
        copy.lessButtonText = text
        return copy
    }
